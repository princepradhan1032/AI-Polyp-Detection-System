...
import numpy as np
import tensorflow as tf
from flask import Flask, request, render_template, url_for, send_from_directory # Added send_from_directory
...
# ----------------- Folders -----------------
# Render/Linux systems always allow writing to /tmp
...
# These routes allow Flask to serve files from /tmp when the HTML asks for /static/...
...
# ----------------- Load Model -----------------
MODEL_PATH = "model5.h5" if os.path.exists("model5.h5") else os.path.join("projects", "model5.h5")
